...
//  BlockLadderApp
//
//  Created by Xiaochen Dai on 6/5/18.
...
extension VpnManager{
    fileprivate func createProviderManager() -> NETunnelProviderManager {
        ...
        conf.serverAddress = "BlockLadder"
        manager.protocolConfiguration = conf
        manager.localizedDescription = "BlockLadder VPN"
        return manager
    }
...
extension VpnManager{
    ...
    fileprivate func setRulerConfig(_ manager:NETunnelProviderManager){
        ...
        conf["ss_address"] = "138.197.223.133" as AnyObject?
        conf["ss_port"] = 8381 as AnyObject?
        conf["ss_method"] = "AES256CFB" as AnyObject?
        conf["ss_password"] = "foobar1" as AnyObject?
